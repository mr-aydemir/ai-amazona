...
>(({ className, label, defaultOpen = true, children, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn("mb-1", className)} {...props}>
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "flex w-full items-center gap-2 px-3 py-2 text-xs font-semibold text-muted-foreground hover:text-foreground",
